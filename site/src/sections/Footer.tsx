...
export function Footer() {
  return <><section className="closing reveal"><p className="eyebrow">{closing.eyebrow}</p><h2>{closing.title}</h2><p>{closing.description}</p><InstallCommand /><Link href={links.examples} className="text-link">{closing.examples}<ArrowUpRight size={16} /></Link></section>
