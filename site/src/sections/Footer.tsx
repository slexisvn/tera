      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="brand" href="#top">
            <img src={project.mark} width="28" height="28" alt="" />
            {project.name}
            <span className="brand-period">.</span>
          </a>
          <span>{closing.footer}</span>
        </div>
        <div className="footer-links">
          <Link href={links.docs}>{ui.docs}</Link>
          <Link href={project.repository}>{ui.github}</Link>
          <a
            href="#top"
            className="icon-button"
            title={closing.top}
            aria-label={closing.top}
          >
            <ArrowUp size={18} />
          </a>
        </div>
