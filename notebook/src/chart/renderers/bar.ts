...
export function renderBar(root: SVGElement, series: ChartSeries, context: RenderContext): void {
...
export function renderHistogram(root: SVGElement, series: ChartSeries, context: RenderContext): void {
...
function barWidth(context: RenderContext, histogram: boolean): number {
