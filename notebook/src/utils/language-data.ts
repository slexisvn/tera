import { buildLanguageDataFromSpec } from "../../../src/frontend/language-data";
import {
  TERA_BUILTINS,
  TERA_CHART_METHODS,
...
export type { Builtin, LanguageData, Method } from "../../../src/frontend/language-data";
