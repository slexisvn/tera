import { createPlayer, DEFAULT_DURATION_MS, DEFAULT_SPEED, SPEED_OPTIONS } from './player.js';
...
export function shouldAnimate(enabled, type, animatableTypes) {
...
export function revealPoints(points, fraction, scale) {
...
export function createAnimationController(host, options = {}) {
...
function buildTransport(getPlayer, frameValues) {
