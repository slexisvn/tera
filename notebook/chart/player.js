...
export function createPlayer({ duration = DEFAULT_DURATION_MS, speed: initialSpeed = DEFAULT_SPEED, loop: initialLoop = false, initialFraction = FRACTION_MAX, onUpdate } = {}) {
