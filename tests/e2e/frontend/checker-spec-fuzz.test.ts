...
describe("checker fuzz invariants", () => {
  ...
  it("fuzzes the operator type matrix including equality, bitwise, membership, and tensor matmul", () => {
    ...
    const good = [
      ...
      "ok_bitwise = 1 << 2",
      "ok_bitwise_truncates_float = 2.5 | 0",
      "ok_bitwise_not_float = ~2.5",
    ...
    const bad = [
      ...
      { label: "bad-bitwise-string", source: 'value = 1 & "2"', message: "Operator '&' cannot be applied to 'int' and 'string'" },
      { label: "bad-bitwise-bool", source: "value = true | 1", message: "Operator '|' cannot be applied to 'bool' and 'int'" },
