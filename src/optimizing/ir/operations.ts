...
export const IR_SPREAD_ELEMENTS = "SpreadElements";
...
export const OPERATIONS = {
  ...
  [IR_SPREAD_ELEMENTS]: { ...store(WRITES_HEAP, TWO_INPUTS), access: ACCESS_PROPERTY, opaqueMemory: true },
