...
export const MAP_METHODS = {
  ...
  entries: {
    ...
    call(_args: TaggedValue[], thisValue: TaggedValue) {
      const map = getMapData(thisValue);
      return wrapEntryIterator(thisValue, map.iterateEntries());
    },
  },
  ...
  keys: {
    ...
    call(_args: TaggedValue[], thisValue: TaggedValue) {
      const map = getMapData(thisValue);
      return wrapValueIterator(thisValue, map.iterateKeys());
    },
  },
  ...
  values: {
    ...
    call(_args: TaggedValue[], thisValue: TaggedValue) {
      const map = getMapData(thisValue);
      return wrapValueIterator(thisValue, map.iterateValues());
    },
  },
